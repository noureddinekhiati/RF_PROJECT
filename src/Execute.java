...
public class Execute {
	...
	//On initialise l'algorithme KMeans à 9 classes
	...
	//Kmean semi supervisé:
			...
			//l'algorithme
		//KM.initCentroids("semi supervisé");
	//Lancement du modèle d'apprentissage
		//KM.startTrain();
	//Sauvgarder les résultats des clusters obtenus
		//KM.saveModel();
		
	//Charger les données de test, évaluer et afficher
