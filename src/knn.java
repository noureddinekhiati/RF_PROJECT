...
public class knn {
	...
	public static void main(String[] args){
		...
		System.out.println(" Testing KNN on E34 sample using Cosine Similarity distance");
		knn("data/E34_train.txt","data/E34_test.txt",1,0);
		System.out.println();

		System.out.println(" Testing KNN on E34 sample using L1 distance");
		knn("data/E34_train.txt","data/E34_test.txt",1,1);
		System.out.println();


		System.out.println(" Testing KNN on E34 sample using Euclidian distance");
		knn("data/E34_train.txt","data/E34_test.txt",1,2);
		System.out.println();
